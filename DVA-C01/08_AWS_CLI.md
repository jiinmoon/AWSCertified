...
- **This is insecure. Never put personal credentials on EC2.**
...
- [Read the doc](https://aws.amazon.com/cli/).
...
- It is a tool to test your policies by simulating service and action performed to
    see the results.
...
- i.e. to see list of roles attached to the EC2 instance:
...
- SDK is supported on most of major language platforms:
    - `Java, .NET, nodejs, PHP, Pyhon, Go, Ruby, C++`
...
- If you get `ThrottlingException` intermittently, use **exponential backoff**
  strategy which is a retry mechanism included in SDK API calls.
...
- **NEVER STORE CREDENTIALS ON CODE**
